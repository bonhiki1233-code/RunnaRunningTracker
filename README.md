...
2.  Sau khi clone về, bảo đảm bạn đã tải xuống và lấy tệp `app/google-services.json` đặt vào bên trong thư mục `app` để kết nối vào Firebase.
3.  Vào console dự án Firebase và kích hoạt tính năng **Firebase Authentication** cùng dự án cơ sở dữ liệu **Cloud Firestore**.
4.  Chọn *Sync Project with Gradle Files* và đợi hệ thống tải toàn bộ các thư viện cần thiết
5.  Chạy ứng dụng trực tiếp trên thiết bị 
